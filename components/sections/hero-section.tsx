      ...
      <div className="container max-w-6xl mx-auto text-center">
        <FadeIn>
          <div className="flex items-center justify-center mb-6">
            <div className="flex items-center gap-2 px-4 py-2 rounded-full border border-border/50 bg-background/10 backdrop-blur-sm">
        ...
        <ScaleIn delay={0.7}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <motion.div 
              className="text-center p-6 rounded-lg border border-border/50 bg-background/5 backdrop-blur-sm"
